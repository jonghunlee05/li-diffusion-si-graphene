#!/usr/bin/env python3
"""
check_model_b_logs.py  --  Phase 5 Model B log inspector.
...
Usage:
    ...
    python analysis/check_model_b_logs.py logs/model_b_minimize.log
"""
...
DEFAULT_LOGS = ["logs/model_b_minimize.log", "logs/model_b_equilibrate_short.log"]
...
def main():
    ap = argparse.ArgumentParser(description="Check Model B minimize/equilibrate logs.")
    ...
    if not any_found:
        ...
        sys.exit(2)
    if overall:
        print("RESULT: PASS -- Model B minimized/equilibrated without collapse.")
        sys.exit(0)
